function align_results_ramres_statisticalAnalysis()
...
% select the files
[files,path] = uigetfile('*.mat', 'Select the files to analyse', pathstr, 'MultiSelect','on');
...
for index_muscle=1:33
    evaluate_mean_std_RaMReS_multipleFiles(path, index_muscle, task_name, files, GH_enforced);
end
