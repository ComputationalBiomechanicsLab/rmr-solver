...
Save in here the results of the analysis performed with the GH constraint on the unloaded flexions (`flx01`, `flx02`, `flx03` - using the correct models with increased hand-mass).