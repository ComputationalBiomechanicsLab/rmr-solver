...
Save in here the results of the analysis performed with the GH constraint on the loaded abductions (`abd01`, `abd02`, `abd03` - using the correct models with increased hand-mass).