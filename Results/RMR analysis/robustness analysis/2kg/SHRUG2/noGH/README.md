...
Save in here the results of the analysis performed without the GH constraint on the loaded shrugs (`shrug21`, `shrug22`, `shrug23` - using the correct models with increased hand-mass).