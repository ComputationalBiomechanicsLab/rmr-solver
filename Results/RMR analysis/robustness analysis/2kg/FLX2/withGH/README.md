...
Save in here the results of the analysis performed with the GH constraint on the loaded flexions (`flx21`, `flx22`, `flx23` - using the correct models with increased hand-mass).