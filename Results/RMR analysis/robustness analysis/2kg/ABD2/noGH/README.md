...
Save in here the results of the analysis performed without the GH constraint on the loaded abductions (`abd21`, `abd22`, `abd23` - using the correct models with increased hand-mass).