...
muscle_SO = muscles_SO(:,2)+muscles_SO(:,4);
warning("SUMMING UP TWO PARTS OF TRAP SUP, as in 2019 CMC")
...
%% (4) - Serratus Anterior
muscle_SO = (muscles_SO(:,6)+muscles_SO(:,5)+muscles_SO(:,7))/3;
warning("AVERAGING ACTIVATIONS FOR SERRATUS ANTERIOR, as in 2019 CMC")
...
warning('COMAPRING DELTOID POSTERIOR TO DeltoideusScapula_M, as in 2019 CMC')
