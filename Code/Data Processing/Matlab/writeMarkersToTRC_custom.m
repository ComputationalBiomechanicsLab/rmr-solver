function err = writeMarkersToTRC(trcfile, Markers, MLabels, Rate, Frames, Time, Units, path)
...
cd(path)                                                                    % Added by Irene Beck (2022/01/27) to save new .trc file in specified location
...
dlmwrite(trcfile, data, '-append', 'delimiter', '\t');                      % Original line by ASeth